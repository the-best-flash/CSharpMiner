...
mcs -optimize+ -recurse:CSharpMiner/GridseedGen1Plugin/*.cs -out:bin/GridseedPlugin.dll -target:library -r:System,System.Core,System.Data,System.Data.DataSetExtensions,System.Runtime.Serialization,CSharpMinerLib.dll
